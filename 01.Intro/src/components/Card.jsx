...
const Card = ({ product }) => {
    ...
    return (
        <div className='min-w-[300px] w-full p-2.5 border border-gray-300 rounded-md shadow-md'>
            <img className='w-full h-[250px] object-contain' src={product.images[0]}></img>
